...
<html>
    ...
    <body>
        ...
        <div class="div-dashboard">
            ...
            na área de <label id="destaque">Despesas</label> você pode lançar suas
            saídas.
            ...
            <div class="conteudo">
                ...
                <table id="tbl">
                    <tr>
                        <td style="width: 30%">
                            <form method="POST" action="insert_sql/insert_despesas.php">
                                <table>
                                    <tr>
                                        <td>
                                            Descrição: *
                        ...
                        <td>
                            <?php
                            $con = conexaoBD();
                            $sql = "CALL despesas_por_user ('$nome_user')";
                            ...
                            <table id="table2" style="margin-top: 5px;">
                                <thead>
                                    <tr>
                                        <th class="th-table2">DESCRIÇÃO</th>
