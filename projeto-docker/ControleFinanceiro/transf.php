...
<html>
    ...
    <body>
        ...
        <div class="div-dashboard">
            ...
            na área de <label id="destaque">Transferências</label> você pode lançar suas
            ...
            <div class="conteudo">
                ...
                <table id="tbl">
                    <tr>
                        <td style="width: 30%">
                            <form method="POST" action="insert_sql/insert_transf.php">
                                <table>
                                    <tr>
                                        <td>
                                            Descrição: *
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="origem" required="required">
                                                <?php $stmtconta->execute();?>
                        ...
                        <td>
                            <?php
                            $con = conexaoBD();
                            $sql = "CALL transf_por_user ('$nome_user')";
                            $stmt = $con->prepare($sql);
                            $stmt->execute();
                            ?>

                            <table id="table3" style="margin-top: 5px;">
                                <thead>
                                    <tr>
                                        <th class="th-table3">DESCRIÇÃO</th>
                                        <th class="th-table3">VALOR</th>
                                        <th class="th-table3">DATA</th>
                                        <th class="th-table3">ORIGEM</th>
                                        <th class="th-table3">DESTINO</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <?php while ($resultado = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="td-table3">
                                                <?php echo $resultado["org"]; ?>
                                            </td>
                                            
                                            <td class="td-table3">
                                                <?php echo $resultado["dest"]; ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            ...
                            <script type="text/javascript" src="javascript/script-table3.js"></script>
                        </td>
                    </tr>
                </table>
            </div>
